...
//                        .repeatCount(3, autoreverses: false)
            ...
            BackCardView()
                ...
                .rotation3DEffect(Angle(degrees: showCard ? 0 : 10), axis: (x: 10.0, y: 10.0, z: 0))
                .blendMode(.hardLight)
            ...
            BackCardView()
                ...
                .rotation3DEffect(Angle(degrees: showCard ? 0 : 5), axis: (x: 10.0, y: 10.0, z: 0))
                .blendMode(.hardLight)
            ...
            BottomCardView()
                ...
                .gesture(
                    ...
                    .onEnded { value in
                        ...
                        if (self.bottomState.height < -50 && !self.showFull) || (self.bottomState.height < -250 && self.showFull) {
                            self.bottomState.height = -300
                            self.showFull = true
                        } else {
